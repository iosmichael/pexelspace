		...
		<div class="main-content">
			<div class= "container">
				<div class="application-forms">
					<div class= "col-sm-10 col-sm-offset-1 form-one" id="mid-content">
						<div class="row" class="step-page">
							...
							<div class="row image-icon col-sm-6 col-sm-offset-3 col-xs-6">
								<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
									<img src="./Assets/Images/submit-project-icon.png">
								</div>
								
							</div>
							<div class="step-descirption col-sm-6 col-sm-offset-3 col-xs-6">
								...
								<ul>
									...
									<li>In what way are you foreseeing to use this website?</li>
								</ul>
							</div>
						</div>
						<div class="submission-button-box"><p class="submission-button"><a href="submission.php">START NOW</a></p></div>
						<div class="divider"></div>
						<div class="row" class="step-page">
							<div class="number">
								<p>2</p>
						...
						<div class="row" class="step-page">
								...
								<div class="image-icon col-sm-6 col-sm-offset-3 col-xs-6">
									<div class=" col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
				...
				<div class="  col-md-10 col-md-offset-1 selection">
					<div class="row">
						<div class="col-md-6 col-sm-6 col-sm-offset-0 col-xs-8 col-xs-offset-2">
							<div class="box" id="selection-form-one">
						...
						<div class=" col-md-6 col-sm-6 col-sm-offset-0 col-xs-8 col-xs-offset-2">
							<div class="box" id="selection-form-two">
								<div id="selection-description">
